...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament appartment : apartaments) {
            if (appartment instanceof Apt1Room) {
                ((Apt1Room) appartment).clean1Room();
            }

            if (appartment instanceof Apt2Room) {
                ((Apt2Room) appartment).clean2Rooms();
            }

            if (appartment instanceof Apt3Room) {
                ((Apt3Room) appartment).clean3Rooms();
            }
        }
    }
